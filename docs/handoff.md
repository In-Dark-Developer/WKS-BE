...
### 2026-09-17 (목) · 차은호 · saju/ 해설에서 '나의 기운' 반복 줄이기 (#76) · Claude Code

**한 일**
- "결혼·자녀·연애 각 풀이의 첫 문장은 나의 기운에서 시작" 규칙이 항목마다 "불의 기운인 당신에게 …" 를 반복시켰다. 운명 설명에서 한 번만 밝히고 각 항목은 그 항목의 기운으로 바로 들어가도록 바꿈
- 역할 설명 규칙(#50)은 유지하되 예시를 "배우자 인연을 뜻하는 물의 기운" 형태로 바꿔 "나의 기운인 당신에게" 를 유도하지 않게 함
- 나의 기운 설명은 **운명 설명(`destinyDescription`)에서만** 제대로 한다. 사람의 모습을 먼저 쓰고, 그것이 태어난 날에서 정해진 어떤 기운인지와 성격으로 어떻게 드러나는지 풀어 주고, 글자가 적어도 그 기운이 중심이라는 점을 담는다. 3~4문장 180자로 늘림(기존 2~3문장 120자)
- 어느 글도 기운 이름으로 시작하지 않고 사람의 모습을 먼저 쓰도록. "기운 → 발현 → 흐름" 순서 원칙은 결혼·자녀·연애 풀이에만 적용
- 입력 항목 이름 금지 목록에 "나의 기운" 추가. "나의 기운인 불" 같은 문장이 그대로 나오던 것 차단
- 실측(일간 병, 불 2·물 4): 각 항목의 나의 기운 반복 사라짐(결혼·연애 모두 해당 기운 또는 사람 모습으로 시작). 운명 설명은 150~179자로 나의 기운을 설명, 합쇼체 0

**건드린 파일/패키지**
- `resources/prompts/reading-system.txt`, `docs/handoff.md`

**다음 사람이 알아야 할 것**
- 더 줄이면 #50 에서 고친 문제(기운 이름만 나오고 무슨 뜻인지 몰라 헷갈림)가 되살아난다. 역할 설명 규칙은 유지할 것
